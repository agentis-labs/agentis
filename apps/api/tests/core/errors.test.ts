...
const CODE_TO_STATUS: Array<[AgentisErrorCode, number]> = [
  ...
  ['SKILL_REGISTRY_PERMISSION_NOT_ACKNOWLEDGED', 403],
  ...
  ['SKILL_REGISTRY_HASH_MISMATCH', 422],
  ['SKILL_REGISTRY_SCAN_BLOCKED', 422],
  ['SKILL_NETWORK_VIOLATION', 422],
  ['SKILL_SSRF_BLOCKED', 422],
  ...
  ['SKILL_REGISTRY_UNAVAILABLE', 503],
  ['SKILL_DOCKER_UNAVAILABLE', 503],
