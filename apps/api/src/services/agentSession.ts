/**
 * AgentSessionService — persistent, DB-backed agent identity at work.
 *
 * SMARTER-AGENTS-10X §VI (Layer 1: The Cognitive Foundation).
 *
 ...
 * message log. Between LLM inference calls the session is just this row — the
 ...
 *
 * This service owns persistence only. The thinking→doing loop, tool execution,
