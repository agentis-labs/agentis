...
const SECTIONS: PaletteSection[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { type: 'component_task',  label: 'Component',       glyph: '⬢', description: 'Run versioned Python or Node code in an isolated OCI container', defaults: { operationName: 'execute', inputMapping: {}, outputMapping: {} } },
