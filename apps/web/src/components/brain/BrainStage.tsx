...
import type { BrainEdge, BrainNode, BrainResponse } from '@agentis/core';
...
export function BrainStage({ brain, selectedId, onSelect, filters }: StageProps) {
