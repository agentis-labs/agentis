...
export function DisputeResolutionPanel({ embedded = false, hideWhenEmpty = false }: { embedded?: boolean; hideWhenEmpty?: boolean } = {}) {
  ...
  if (hideWhenEmpty && disputes.length === 0) return null;

  return (
    <main className={embedded ? '' : 'h-full overflow-y-auto px-5 py-5'}>
