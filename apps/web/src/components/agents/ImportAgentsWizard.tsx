    ...
    >
      ...
      {agents && agents.length === 0 && !scanning && (
        <div className="rounded-lg border border-line bg-surface p-6 text-center">
          ...
          <p className="mt-1 text-[12px] text-text-muted">We looked for Claude Code, Hermes, Codex, Cursor, Gemini CLI and Antigravity CLI agents (and their memory + skills) on this machine.</p>
        </div>
      )}
