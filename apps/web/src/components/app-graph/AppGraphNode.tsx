...
const COLORS: Record<AppGraphNodeType, { bg: string; ring: string; icon: string; tag: string }> = {
  ...
  entry_workflow:     { bg: 'bg-cyan-500/15',   ring: 'ring-cyan-400/40',   icon: 'text-cyan-300',    tag: 'Entry' },
  workflow_module:    { bg: 'bg-cyan-500/10',   ring: 'ring-cyan-400/25',   icon: 'text-cyan-300',    tag: 'Workflow' },
  agent_group:        { bg: 'bg-amber-500/15',  ring: 'ring-amber-400/40',  icon: 'text-amber-300',   tag: 'Agents' },
  ...
  integration_surface:{ bg: 'bg-slate-500/15',  ring: 'ring-slate-400/40',  icon: 'text-slate-300',   tag: 'Integration' },
  approval_surface:   { bg: 'bg-rose-500/15',   ring: 'ring-rose-400/40',   icon: 'text-rose-300',    tag: 'Approval' },
