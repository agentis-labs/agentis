...
import { Bot, Plus, Network, List as ListIcon, Search, SearchX, X, Zap, Sparkles, Download, ChevronDown, FolderInput, PackagePlus, UserPlus, Brain as BrainIcon, SlidersHorizontal } from 'lucide-react';
