...
See [`.env.example`](https://github.com/nexseed/agentis/blob/main/.env.example) for the full set.
...
- Project: <https://github.com/nexseed/agentis>
- Technical guide: <https://github.com/nexseed/agentis/tree/main/docs>
