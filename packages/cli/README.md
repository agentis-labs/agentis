...
> **Status: 1.1.2 stable.** Agentis is now in public release, and the CLI,
...
agentis doctor [--json]            Verify Node/ABI, data access, SQLite/database, and model runtime health.
