...
- **2026-07-01 — SPEC authored.** Diagnosis grounded in the Fashion Store transcript + `project_fashion_store_factory_rootcause` (shape-nesting cut) + `project_agent_build_loop` (P0–P5 shipped). Nothing built yet. Extends, does not replace, the AGENT-BUILD-LOOP work.
